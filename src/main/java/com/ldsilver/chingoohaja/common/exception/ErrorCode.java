...
public enum ErrorCode {
    ...
    IMAGE_FILE_EMPTY(HttpStatus.INTERNAL_SERVER_ERROR, "U008", "이미지 파일이 비어있습니다."),
    IMAGE_FILE_OVERSIZED(HttpStatus.INTERNAL_SERVER_ERROR, "U009", "이미지 파일 크기는 5MB를 초과할 수 없습니다."),
