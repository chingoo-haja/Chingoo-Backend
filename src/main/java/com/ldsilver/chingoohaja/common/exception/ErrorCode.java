...
public enum ErrorCode {
    ...
    BIT_RATE_TOO_SMALL(HttpStatus.BAD_REQUEST, "L026", "비트레이트는 0 이상이어야 합니다."),
    PACKET_LOSS_RANGE_INVALID(HttpStatus.BAD_REQUEST, "L027", "패킷 손실률은 0-100% 범위여야 합니다."),
    CALL_USER_NOT_EQUAL(HttpStatus.BAD_REQUEST, "L028", "통화 참가자는 서로 다른 사용자여야 합니다."),
    AGORA_RESOURCE_ID_REQUIRED(HttpStatus.BAD_REQUEST, "L029", "Agora Resource ID는 필수입니다."),
    AGORA_SID_REQUIRED(HttpStatus.BAD_REQUEST, "L030", "Agora SID는 필수입니다."),
