...
public enum ErrorCode {
    ...
    CALL_REQUIRED(HttpStatus.BAD_REQUEST, "L20", "Call은 필수입니다."),
    USER_REQUIRED(HttpStatus.BAD_REQUEST, "L21", "User은 필수입니다."),
    AGORA_UID_REQUIRED(HttpStatus.BAD_REQUEST, "L22", "Agora UID는 필수입니다."),
    RTC_TOKEN_REQUIRED(HttpStatus.BAD_REQUEST, "L23", "RTC Token은 필수입니다."),
    INVALID_PARTICIPANT(HttpStatus.BAD_REQUEST, "L24", "사용자는 해당 통화의 참가자가 아닙니다."),
