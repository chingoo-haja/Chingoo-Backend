...
public enum ErrorCode {
    ...
    INVALID_CREDENTIALS(HttpStatus.UNAUTHORIZED, "C005", "이메일 또는 비밀번호가 올바르지 않습니다."),
    ...
    INVALID_OAUTH_TOKEN(HttpStatus.UNAUTHORIZED, "A011", "유효하지 않은 OAuth 토큰입니다."),
    ...
    INVALID_PHONE_NUMBER_LENGTH(HttpStatus.BAD_REQUEST, "U015", "잘못된 전화번호 길이입니다."),
    ...
    FILE_NOT_FOUND(HttpStatus.BAD_REQUEST, "FS007", "파일을 찾ㅇ르 수 없습니다."),
    // 매칭 관련 에러
