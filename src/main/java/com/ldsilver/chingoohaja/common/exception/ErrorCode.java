...
public enum ErrorCode {
    ...
    STATUS_NOT_WAITING(HttpStatus.BAD_REQUEST, "M007", "대기 중인 상태에서만 취소할 수 있습니다. 현재 상태: "),
    START_MATCHING_FAILED(HttpStatus.BAD_REQUEST, "M008", "대기 중인 상태에서만 매칭을 시작할 수 있습니다. 현재 상태: "),
    MATCHING_EXPIRED_FAILED(HttpStatus.BAD_REQUEST, "M009", "대기 중인 상태에서만 만료할 수 있습니다. 현재 상태: "),
